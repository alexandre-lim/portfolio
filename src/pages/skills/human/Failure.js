  ...
  <Row className= "content-row">
    ...
    <Row className="skill-content">
      ...
      <Row type="flex" className="">
        ...
        <p>
          Cela m'est arrivé plusieurs fois dans les compétitions sportives mais aussi pour le projet It'School. Ce projet est
        ...
        <p>
          ...
          l'application Beneylu. Cela m'a aussi permis de rencontrer mon entreprise actuelle Abbeal et de travailler sur
          l'extraordinaire projet Syllabo.
        </p>
        <p>
      ...
      <Row type="flex">
        <p>
          ...
          mon mindset me permettra de rebondir et d'aller de l'avant. Le monde professionnel est vaste et compétitif.
          ...
          processus de mise en production plus fiable ou mieux cerner les besoins de mon client.
        </p>
      </Row>
      <Row type="flex">
