    ...
    <Row className="skill-content">
      ...
      <Row type="flex" className="skill-introduction">
        ...
        <p>
          ...
          il devient nécessaire de ralentir la cadence, de se recentrer pour se construire.
        </p>
        <p>
      ...
      <Row type="flex" className="">
        <p>
          ...
          avoir peu de relations mais privilégié la qualité. Cela m'a souvent valu d'être mis de côté
          mais je décidais quand même de ne pas porter un masque et rester simplement moi-même.
        </p>
        <p>
          C'est lors de mon arrivée à In'tech que tout changea et qu'on m'a accepté comme j'étais.
          J'ai rencontré des gens formidables avec qui j'ai noué de fortes relations.
          Plus que des amis, c'est la famille. L'intégrité m'a permis de ne pas me perdre, de libérer mon potentiel
          pour accomplir des projets comme It'School et Improv'it. On me fait confiance car mon entourage connait
      ...
      <Row type="flex">
        <p>
          ...
          L'intégrité représente une force dans le monde professionnel car la loyauté et l'honnêteté
          sont des valeurs appréciées de toute personne. Mes collaborateurs n'hésitent pas à me confier
          des tâches importantes et me font confiance.  J'ai une grande autonomie sur le projet Syllabo et
      ...
      <Row type="flex">
        <p>
          ...
          car on évite des relations toxiques. Professionnellement, nous sommes respectés car on se respecte.
