...
const Teamwork = () => (
  <Row className= "content-row">
    ...
    <Row type="flex" className="skill-introduction">
      <p>
        La vie est une suite d'aventure jonchée d'obstacles pour atteindre des sommets.
      ...
      <p>
        ...
        Le temps passe, tout est éphémère et le travail d'équipe permet de soulever des montagnes et de réaliser votre épopée.
      ...
      <p>
        Selon moi, une équipe doit partager des valeurs et un ou plusieurs objectifs assez forts pour mettre en place une cohésion,
        une synergie. Ceci qu'importe les différences entres les individus du groupe.
      </p>
    </Row>
    <Row type="flex">
    ...
    <Row type="flex" className="">
      <p>
        It'School (lien) a été le projet le plus marquant que j'ai pu réaliser.
      ...
      <p>
        ...
        De plus le but du projet était de délivrer une application à des enseignants qui sera utiliser par des enfants.
        Il y avait du sens dans notre métier de développeur. Nous avons en commun notre pourquoi : Mettre nos compétences
        aux services d'autrui.
      </p>
      <p>
        Tout cela à amener à une synergie forte de l'équipe et a permis de tester le produit au sein d'une école privée.
    ...
    <Row type="flex">
      <p>
        ...
        potentiel pour réaliser nos objectifs. Techniquement et humainement, je suis engagé pour permettre
        la cohésion et la synergie de l'équipe.
      </p>
      <p>
    ...
    <Row type="flex">
      ...
      <p>
        Une entreprise est une grande équipe, je souhaite donc intégrer un groupe dont je partage les valeurs
